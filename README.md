...
Here the HTTP Specs are simplified for easir implmentation.

### HTTP Messages

HTTP follows the [general HTTP message format](https://developer.mozilla.org/en-US/docs/Web/HTTP/Messages). And it has some further specifications:
...
In one terminal, start the SitanHTTP server:
```
